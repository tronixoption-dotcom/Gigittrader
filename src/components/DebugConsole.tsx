...
export function DebugConsole() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("digittrader-debug-log", onLog);
    window.addEventListener("digittrader-debug-log-cleared", onLog);
    window.addEventListener("error", onError);
    window.addEventListener("unhandledrejection", onUnhandled);
    document.addEventListener("click", onClick, true);

    return () => {
      window.removeEventListener("digittrader-debug-log", onLog);
      window.removeEventListener("digittrader-debug-log-cleared", onLog);
